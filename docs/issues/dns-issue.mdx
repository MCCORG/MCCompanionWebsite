...
- **Config Sent** - Verify the DNS config was sent properly in the NetherLink app
- **Accepts Bedrock Players** - Make sure the server you are trying to connect to allows Bedrock players to connect, we don't support Java-only servers yet
