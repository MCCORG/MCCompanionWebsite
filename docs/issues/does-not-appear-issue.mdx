...
Enable **Debug Mode** in the NetherLink app. Check the logs; they usually point directly to the problem. You can also try connecting to a different server to rule out a server-side issue.
